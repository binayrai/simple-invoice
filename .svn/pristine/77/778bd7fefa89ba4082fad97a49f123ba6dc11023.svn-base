...
public class ListReocurrenceController {
    ...
    public void downloadPdf() {
        ...
        try {
            ...
            Messages.addInfo(null, "Invoice not generated for this month(" + format.format(indexDate) + ")");
        }
    ...
    public void downloadPDF(String filePath) throws IOException {
        ...
        response.addHeader("Content-Disposition", "attachment; filename=invoice_" + FrequencyType.Monthly + "_Invoice_" + format.format(indexDate) + ".pdf");
