...
class Assembler implements Serializable {
    ...
    UserDetails buildUserFromUserEntity(User userEntity) {
        ...
        CustomSpringSecurityUser user = new CustomSpringSecurityUser(username, password, enabled, accountNonExpired, credentialsNonExpired, accountNonLocked, authority, userEntity.getRoleType(), userEntity.getCompanyCode(), userEntity.getCustomerCode());
